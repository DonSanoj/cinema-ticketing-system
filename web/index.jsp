...
<body class="bg-gray-100">
    ...
    <section class="bg-white text-white">
        ...
        <!-- Main Carousel -->
        <section class="container mx-auto my-12 relative bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="relative">
                <div id="slider" class="flex transition-transform duration-500 ease-in-out">
                    <!-- Slide 1 -->
                    <div class="min-w-full relative">
                        <img src="./assets/img/img-6.jpg" alt="The Wild Robot" class="w-full h-45 object-cover brightness-75">
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="text-center">
                                <h2 class="text-5xl font-bold mb-4">THE WILD ROBOT</h2>
                                <button class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg shadow-lg transition-transform duration-200 transform hover:scale-105">Buy Tickets</button>
                            </div>
                        </div>
                    </div>
                    <!-- Slide 2 -->
                    <div class="min-w-full relative">
                        <img src="./assets/img/img-2.jpg" alt="Smile 2" class="w-full h-45 object-cover brightness-75">
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="text-center">
                                <h2 class="text-5xl font-bold mb-4">SMILE 2</h2>
                                <button class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg shadow-lg transition-transform duration-200 transform hover:scale-105">Buy Tickets</button>
                            </div>
                        </div>
                    </div>
                    <!-- Slide 3 -->
                    <div class="min-w-full relative">
                        <img src="./assets/img/img-3.jpg" alt="Venom 2" class="w-full h-45 object-cover brightness-75">
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="text-center">
                                <h2 class="text-5xl font-bold mb-4">VENOM 2</h2>
                                <button class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg shadow-lg transition-transform duration-200 transform hover:scale-105">Buy Tickets</button>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Carousel Controls -->
                <button id="prevBtn" class="absolute left-4 top-1/2 transform -translate-y-1/2 bg-gray-700 bg-opacity-60 hover:bg-opacity-80 text-white rounded-full p-3 shadow-lg transition-transform duration-200 hover:scale-110">
                    <span class="material-icons">chevron_left</span>
                </button>
                <button id="nextBtn" class="absolute right-4 top-1/2 transform -translate-y-1/2 bg-gray-700 bg-opacity-60 hover:bg-opacity-80 text-white rounded-full p-3 shadow-lg transition-transform duration-200 hover:scale-110">
        ...
        <section class="bg-black py-12">
            <h2 class="text-2xl text-white font-bold mb-8 text-center">Now Showing</h2>

            <!-- Movie Cards Grid -->
            <section class="container mx-auto grid grid-cols-2 md:grid-cols-3 gap-4">
                <!-- Large Card -->
                <div class="col-span-2 row-span-2 bg-gray-800 rounded-lg relative h-64 md:h-96 shadow-lg hover:scale-105 transition-transform duration-300">
                    ...
                    <div class="absolute bottom-4 left-4 text-white">
                        <h4 class="text-xl font-bold">Movie Name</h4>
                        <p class="text-gray-300">Show Info</p>
                    </div>
                </div>
                ...
                <div class="bg-gray-800 rounded-lg relative h-32 md:h-48 shadow-lg hover:scale-105 transition-transform duration-300">
                    ...
                    <div class="absolute bottom-4 left-4 text-white">
                        <h4 class="text-lg font-bold">Movie Name</h4>
                        <p class="text-gray-300">Show Info</p>
                    </div>
                </div>
