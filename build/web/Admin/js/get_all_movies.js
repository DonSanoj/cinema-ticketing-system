...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            // Update Total Users and Total Movies counts
            $('.bg-white p.text-2xl.font-bold.text-blue-600').text(data.totalUsers);
            $('.bg-white p.text-2xl.font-bold.text-green-600').text(data.totalMovies);
