 ...
 * @author Local
 */
@WebServlet("/indexcomingsoon")
public class IndexComingSoonServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            ArrayList<Movie> moviesComingSoon = movieDAO.getComingSoonMovies();
            System.out.println("Movies fetched: " + moviesComingSoon.size());

            if (moviesComingSoon.isEmpty()) {
                System.out.println("No movies found in the database.");
            } else {
                moviesComingSoon.forEach(movie -> System.out.println("Movie: " + movie.getMovieName()));
            }
            ...
            if (ajaxRequest != null && ajaxRequest.equals("XMLHttpRequest")) {
                try {
                    ...
                    Gson gson = new Gson();
                    String jsonResponse = gson.toJson(moviesComingSoon);
